    ...
    async def create_data(self) -> None:
        ...
        add_book_data = f"""
            INSERT INTO {cfg.DatabaseTables.BOOKS.value}({book_columns}) VALUES (
                ...
                '2015-02-01', 'This remarkable book by Dr. Joseph Murphy, one of the pioneering voices of affirmative thinking, will unlock for you the truly staggering powers of your subconscious mind. Combining time-honored spiritual wisdom with cutting edge scientific research, Dr. Murphy explains how the subconscious mind influences every single thing that you do and how, by understanding it and learning to control its incredible force, you can improve the quality of your daily life.Everything, from the promotion that you wanted and the raise you think you deserve, to overcoming phobias and bad habits and strengthening interpersonal relationships, the Power of Your Subconscious Mind will open a world of happiness, success, prosperity and peace for you. It will change your life and your world by changing your beliefs.'
            ), (
        ...
        add_review_data = f"""
            INSERT INTO {cfg.DatabaseTables.REVIEWS.value}({review_columns}) VALUES (
                ...
                '1', '3', 'Namasteji, This BOOK is unexplainable, it should be experienced each and every sentence, Spiritually, Physically in the life. THE GRACE & THE PRESENCE of SRI SRI AMMABHAGAVAN are flowing through YOU & YOUR BOOK. Many,many thanks to you & your family members, your ancestors & your team. AMMABHAGAVAN BLESS YOU & YOUR FAMILY.', '5'
            ), (
                '2', '3', 'Loved it :)', '4'
            ), (
                '2', '4', 'I didnt like the read to be honest, the author has no concrete points to make or teach through his book rather he has taken a lot of biblical verses and kept on praising it for some weird reasons With very minimal content to learn from, he tried his best to link it with conscious and subconscious thoughts and concepts which I found was absurd coz he didnt do it well and science could explain it well. As an Indian I feel reading our own philosophical books would make much sense and would be relatable than reading this. It was my worst read till tills day, never buying a book from these western preachers again, they dont understand philosophy really well and they try impose Ancient Indian teaching on us in a very bad manner(JK)!', '1'
            ), (
                '3', '1', 'The content of the book is fascinating but the only problem which I face is the bent on the edge of the book. You can go ahead with this book, one another issue which I face is that pages quality are not upto the mark. This is one of the best book for overthinkers.', '4'
            ), (
